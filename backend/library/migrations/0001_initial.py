    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('LIBRARIAN', 'Librarian'), ('STUDENT', 'Student')], default='STUDENT', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_genres', models.CharField(blank=True, help_text='Comma-separated genres for AI baseline', max_length=255)),
