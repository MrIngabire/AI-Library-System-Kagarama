...
SECRET_KEY = 'django-insecure-@pwz)1kxn#u9ql!^_*v6pc+^v241t-+p72i6u9gqysir^ab^89'
DEBUG = True
ALLOWED_HOSTS = ['*']
...
# ==========================================
# 8. INTERNATIONALIZATION, STATIC & MEDIA FILES
# ==========================================
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'UTC'
USE_I18N = True
...
# NEW: Tells Django where to save and serve uploaded book cover images
MEDIA_URL = '/media/'
